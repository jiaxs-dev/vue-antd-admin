<template>
  <div class="container">
    <div class="content">
      <div class="top">
        <div class="header">
          <img alt="logo" class="logo" src="../../assets/img/logo_dandu.png" />
          <span class="title">{{systemName}}</span>
        </div>
        <div class="desc">东奥会计在线 - 会计职称考试培训「专注会计职业教育22年」</div>
      </div>
      <div class="login">
...
<style lang="less" scoped>
  .container {
    ...
    height: 100vh;
    overflow: auto;
    background: #f0f2f5 url('../../assets/img/TVYTbAXWheQpRcWDaDMu.svg') no-repeat center 110px;
    background-size: 100%;
    .content {
      padding: 32px 0;
      flex: 1;
